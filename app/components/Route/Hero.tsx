    ...
    return (
        <div className='w-full 1000px:flex items-center'>
            ...
            <div className='1000px:w-[40%] flex 1000px:min-h-screen items-center justify-center pt-[70px] 1000px:pt-[0] z-10'>
                <Image src={require("../../../public/assets/banner-img-1.png")} alt="" className='object-contain 1100px:max-w-[80%] w-[70%] 1500px:max-w-[85%] h-[auto] z-[10]'/>
            </div>
            <div className='1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]'>
                <h2 className='dark:text-white text-[#000000c7] text-[30px] px-3 w-full 1000px:text-[70px] font-[600] font-Josefin py-2 1000px:leading-[75px] 1500px:w-[600px] typewriter'>
                    Мгновенно улучшите свой опыт онлайн-обучения
                </h2>
                <br />
                <p className='dark:text-[#edfff4] text-[#000000ac] font-Josefin font-[600] text-[18px] 1500px:!w-[55%] 1100px:!w-[78%]'>
                    У нас более 40 тысяч онлайн-курсов и более 500 тысяч онлайн-зарегистрированных студентов. Найдите среди них свой курс.
                </p>
                <br />
                <br />
