...
const DashboardHeader:FC<IDashboardHeader> = ({open, setOpen}) => {
                ...
                <div className='w-[350px] h-[50vh] overflow-y-auto dark:bg-[#111c43] bg-white shadow-xl absolute top-16 z-10 rounded'>
                    ...
                    {notifications &&
                        notifications.map((item: any, index: number) => (
                            <div
                                className="dark:bg-[#1e2735] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#0000000f]"
                                key={index}
                            >
                                <div className="w-full flex items-center justify-between p-2">
                                    <p className="text-black dark:text-white">{item.title}</p>
                                    <p
                                        className="text-black cursor-pointer bg-[#8b95d9] p-3"
