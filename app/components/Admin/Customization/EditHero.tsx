...
const EditHero: FC = () => {
    ...
    useEffect(() => {
        ...
        if (isSuccess) {
            toast.success("Стартовая страница успешно обновлена!");
            refetch();
        }
        if (error) {
            if ("data" in error) {
        ...
        <>
            {isLoading ? (
                ...
                <div className="w-full 1000px:flex items-center">
                    <div
                        className="absolute top-[100px] 1000px:top-[unset] 1500px:h-[600px] 1500px:w-[600px] 1100px:h-[400px] 1100px:w-[400px] h-[40vh] w-[40vh] hero_animation rounded-[50%] 1100px:left-[14rem] 1500px:left-[18rem]"></div>
                    <div
