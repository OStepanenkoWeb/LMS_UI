            ...
            <div className="w-[90%] 800px:w-[90%] m-auto py-5">
                <div className="w-full flex flex-col-reverse 800px:flex-row">
                    <div className="w-full 800px:w-[65%] 800px:pr-5">
                        ...
                        <div className="flex items-center justify-between pt-3">
                            <div className="flex items-center">
                                ...
                                <h5 className="text-black dark:text-white">
                                    {data.reviews?.length} Отзывы
                                </h5>
                            </div>
                            <h5 className="text-black dark:text-white">
                                {data.purchased} Обучающиеся
                            </h5>
                        </div>
                        ...
                        <h1 className="text-[25px] font-Montserrat font-[600] text-black dark:text-white">
                            Что послужило причиной приобрести этот курс?
                        </h1>
                        ...
                        <div className="w-full">
                            <div className="800px:flex items-center">
                                ...
                                <h5 className="text-[25px] font-Montserrat text-black dark:text-white">
                                    ...
                                    Рейтинг курса • {data?.reviews?.length} Отзывов
                                </h5>
                            </div>
                            <br />
                    ...
                    <div className="w-full 800px:w-[35%] relative">
                        <div className="sticky top-[100px] left-0 z-50 w-full">
                            ...
                            <div className="flex items-center">
                                {isPurchased ? (
                                    <Link
                                        className={`${styles.button} !w-[180px] my-3 font-Montserrat cursor-pointer !bg-[crimson]`}
