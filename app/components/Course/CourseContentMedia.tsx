    ...
    useEffect(() => {
        if (isSuccess) {
            ...
            socketId.emit("notification", {
                title: `Получен новый вопрос`,
                message: `У вас есть новый вопрос в ${data[activeVideo].title}`,
                userId: user._id,
            });
        }
        if (answerSuccess) {
            ...
            if (user.role !== "admin") {
                socketId.emit("notification", {
                    title: `Получен новый ответ`,
                    message: `У вас есть новый ответ на вопрос ${data[activeVideo].title}`,
                    userId: user._id,
                });
            }
        }
        ...
        if (reviewSuccess) {
            ...
            socketId.emit("notification", {
                ...
                message: `У вас новый отзыв в ${data[activeVideo].title}`,
                userId: user._id,
            });
        }
        if (reviewError) {
        ...
        <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
            ...
            <div className="w-full flex items-center justify-between my-3">
                <div
                    ...
                    } text-white items-center  font-Montserrat !w-[unset] !min-h-[40px] !py-[unset] ${activeVideo === 0 && "!cursor-no-drop opacity-[.8]"
                    }`}
                    onClick={() =>
                ...
                <div
                    className={`${styles.button
                    } !w-[unset] text-white  items-center  font-Montserrat !min-h-[40px] !py-[unset] ${data.length - 1 === activeVideo && "!cursor-no-drop opacity-[.8]"
                    }`}
                    onClick={() =>
                        setActiveVideo(
            ...
            <div className="w-full p-4 flex items-center justify-between bg-slate-500 bg-opacity-20 backdrop-blur shadow-[bg-slate-700] rounded shadow-inner">
                {["Обзор", "Ресурсы", "Q&A", "Отзывы"].map((text, index) => (
                    <h5
                        key={index}
            ...
            {activeBar === 2 && (
                <>
                    ...
                    <div className="w-full flex justify-end">
                        <div
                            className={`${styles.button
                            } !w-[120px] !h-[40px] font-Montserrat mt-5 ${questionCreationLoading && "cursor-not-allowed"
                            }`}
                        ...
                        {!isReviewExists && (
                            <>
                                <div className="flex w-full">
                                    ...
                                    <div className="w-full">
                                        <h5 className="pl-3 text-[20px] font-[500] dark:text-white text-black ">
                                            Дайте оценку <span className="text-red-500">*</span>
                                        </h5>
                                ...
                                <div className="w-full flex justify-end">
                                    <div
                                        className={`${styles.button
                                        } !w-[120px] !h-[40px] mt-5 font-Montserrat 800px:mr-0 mr-2 ${reviewCreationLoading && "cursor-no-drop"
                                        }`}
                                        onClick={
                                        ...
                                        <div className="w-full my-5 dark:text-white text-black" key={index}>
                                            ...
                                            {isReviewReply && reviewId === item._id && (
                                                <div className="w-full flex relative">
                                                    ...
                                                    <button
                                                        type="submit"
                                                        className="absolute font-Montserrat right-0 bottom-1"
